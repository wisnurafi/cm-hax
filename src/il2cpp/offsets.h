...
#define OFF_PLAYERMOVEMENT_ISSLIDING        0x93
#define OFF_PLAYERMOVEMENT_ISJUMPINPUT      0xA4
#define OFF_PLAYERMOVEMENT_ISMOVEUPINPUT    0xA5
#define OFF_PLAYERMOVEMENT_ISCROUCHINPUT    0xA7
#define OFF_PLAYERMOVEMENT_GRAVITY          0xBC
#define OFF_PLAYERMOVEMENT_ISGROUNDED       0xC0
#define OFF_PLAYERMOVEMENT_SPRINTSTAMINA    0xD0
